...
const partners = [
  { name: 'Restaurant', logo: '/Logo1.png' },
  { name: 'Bakery', logo: '/Logo2 (1).png' },
  { name: 'Fork & Spoon', logo: '/Logo3.png' },
  { name: 'Wolf Coffee', logo: '/Logo4.png' },
  { name: 'Bistro', logo: '/Logo5.png' },
  { name: 'Bakery', logo: '/Logo6.png' },
]
