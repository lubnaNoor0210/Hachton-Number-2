...
function Hero() {
  ...
  return (
    <div>
      <section className='w-full bg-[url("/Rectangle 8879.png")] bg-cover bg-no-repeat bg-center py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28'>
  ...
  >
    Next
        ...
        <div className="w-full md:w-[30%] lg:w-[25%] bg-white p-6">
          ...
          <Image src="/pic45.png" alt="Category" height={286} width={248} className="  mb-6" />
