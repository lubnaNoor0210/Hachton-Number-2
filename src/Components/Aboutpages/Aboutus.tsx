  ...
  return (
    <div>
        ...
        <div className="container mx-auto flex px-5 py-24">
          <div className="flex flex-col md:flex-row items-center md:space-x-4 mt-2 ml-2">
            <Image
              ...
              alt="hero"
              src= "/pic84.png" width={309} height={536} 
            />
          </div>
          {/* Right Images */}
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div className="flex justify-center">
              ...
              <button className="ml-4 inline-flex text-black  border-0 py-2 px-3 focus:outline-none rounded text-lg">
               <div className="mr-2 block"> <IoPlayOutline /> </div>{/* Icon on the left */}
                Watch video
              </button>
            </div>
          </div>
      ...
      <section className="text-white body-font">
        ...
        <div className="mb-10 object-cover object-center w-[1320px] h-[386px] mx-auto mt-10">
          <Image
          className="mb-10 object-cover object-center w-1320px h-386px mt-1552px ml-300px mt-10"
          alt="hero"
          src = "/mainpic.png"
