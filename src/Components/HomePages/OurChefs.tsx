    ...
    <div>
      ...
      Chefs
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-[20px] mt-[50px]">
          <Image src="/Chef card1.png" alt=""  width={100} height={100} className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer"/>
          <Image src="/Chef Card 2.png" alt=""  width={100} height={100} className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer" />
          <Image src="/Chef Card 3.png" alt=""  width={100} height={100} className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer" />
          <Image src="/Chef Card 4.png" alt=""  width={100} height={100} className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer" />
        </div>
      </section>
    </div>
  )
