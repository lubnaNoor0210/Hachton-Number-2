...
function HomePage() {
  return (
    ...
    <section className="bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row  md:items-center py-[50px]">
        {/* Heading */}
        <div className='text-white w-full sm:mt-8 tex md:w-1/2 space-y-4'>
  ...
  <div style={{ display: 'flex', alignItems: 'center'}}>
    <img
      ...
      style={{
        width: '100px',
        height: '300px',
        position: 'absolute', // Optional if you want to position it specifically
        top: '150px',
        left: '50px',
    ...
    <img
      ...
      alt="Description"
      style={{
        width: '100%',  /* You can adjust this value as per your needs */
        height: '100%',
        objectFit: 'contain',
      }}
    />
  ...
  <Button className='bg-[#FF9F0D] text-white w-[100px] h-[30px] md:w-[190px] md:h-[60px] rounded-[40px] mt-[32px] hover:bg-yellow-800'>
    See More
      ...
      alt="Description"
      style={{
        width: '45%',  /* You can adjust this value as per your needs */
        height: '100%',
        objectFit: 'contain',
      }}
    />
        ...
        <h1 className="text-[20px] md:text-[50px] font-bold whitespace-nowrap">
  ...
  <span>foody product</span>
      ...
      <div className="mt-[50px] md:mt-0 mx-4">
        <Image src="/Aboutpic1.png" alt="Hero Image" className="h-[360px] sm:w-[660px] rounded-md" width={660} height={330} />
        <div className="flex flex-col md:flex-row gap-5 sm:flex-row mt-[16px] lg:mt-[45px] w-full justify-between">
          <Image src="/Aboutpic2.png" width={400} height={200} alt="Hero Image" className="elative w-full sm:w-[280px] md:w-[390px] lg:w-[300px] h-[200px] mb-4 md:mb-0" />
          <Image src="/Aboutpic3.png" width={400} height={200} alt="Hero Image" className="elative w-full sm:w-[280px] md:w-[390px] lg:w-[300px] h-[200px] mb-4 md:mb-0" />
        </div>
      </div>
    </section> 
    </>
